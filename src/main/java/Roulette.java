...
public class Roulette {
    ...
    public static List<Player> RouletteSolver(Characteristics characteristics, int K) {
        if( K <= 0 ) {
            System.exit(1);
        }
